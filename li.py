...
lbl1 = Label(root, text='Enter the Task :', padx=10, pady=10, fg='black', bg='blue')
lbl2 = Label(root, text='Enter the Task Number to delete :', padx=10, pady=10, fg='black', bg='blue')
txt1 = Entry(root, width=30, borderwidth='3', relief='solid')
txt2 = Entry(root, width=7, borderwidth='2', relief='solid')

btn1 = Button(root, text='Add Task', padx=20, pady=10, command=addTask, bg='yellow')
btn3 = Button(root, text='Delete Task', padx=20, pady=10, bg='yellow', command=deleteTask)
btn4 = Button(root, text='Delete All Tasks', padx=20, pady=10, bg='yellow', command=deleteAll)
btn5 = Button(root, text='Exit', padx=20, pady=10, bg='yellow', command=exitW)
toggle_button = Button(root, text="Toggle Complete", command=toggleComplete, bg='yellow')
...
task_field = Text(frame, width=20, height=30, wrap=WORD, font=custom_font, bg='red')
task_field.pack()
